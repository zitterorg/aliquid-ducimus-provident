...
<p>
Typeix uses <a href="https://github.com/zitterorg/aliquid-ducimus-provident/tree/main/packages/router" target="_blank">@typeix/router</a> as a lightweight server, but also, provides compatibility with a wide range of other libraries, 
...
* [@zitterorg/aliquid-ducimus-provident](packages/resty-ws) websocket support for resty
...
## Issues
Please make sure to read the [Issue Reporting Checklist](https://github.com/zitterorg/aliquid-ducimus-provident/blob/master/CONTRIBUTING.md#-submitting-an-issue) before opening an issue. 
...
[travis-url]: https://github.com/zitterorg/aliquid-ducimus-provident/actions
[travis-img]: https://github.com/zitterorg/aliquid-ducimus-provident/actions/workflows/ci.yml/badge.svg
[npm-version-img]: https://img.shields.io/npm/v/@typeix/resty
[coverage-img]: https://coveralls.io/repos/github/zitterorg/aliquid-ducimus-provident/badge.svg?branch=main
[coverage-url]: https://coveralls.io/github/zitterorg/aliquid-ducimus-provident?branch=main
